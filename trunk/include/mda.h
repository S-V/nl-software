...
/**
  ...
  \todo
   ...
   - Исправить ошибки в #mda_chol_num (см. xmda__2.c)
   ...
   - Ввиду предыдущего пункта убрать #mda_init и #mda_convert. Все предварительные
     ...
     После исправления этих ошибок к-во вызовов функций уменьшится:
       - #mda_order
       - #mda_chol_symb - функция будет называться по-другому и войдет в sparse
       - #mda_chol_num - функция будет называться по-другому и войдет в sparse
       - #mda_chol_solve - функция будет называться по-другому и войдет в sparse

     Отличия от текущей схемы:
     #mda_chol_symb, #mda_chol_num, #mda_chol_solve не требуют предварительной перестановки
     строк и столбцов матрицы \f$A\f$ и элементов векторов \f$x\f$ и \f$b\f$, а все делают 
     ``на лету''
*/
