...
/**
  ...
  Решается трехдиагональная система порядка \f$n\f$: 

  \f$
    \left(
    \begin{array}{cccccc}
    d_1   &   c_1   &    0    &  \dots     &   0      & 0       \\
    a_1   &   d_2   &   c_2   &  \dots     &   0      & 0       \\
    0     &   a_2   &   d_3   &  \dots     &   0      & 0       \\
    \multicolumn{6}{c}{\dotfill}                                \\
    0     &   0     &   0     &  \dots     &  d_{n-1} & c_{n-1} \\
    0     &   0     &   0     &  \dots     &  a_{n-1} & d_n     \\
    \end{array}
    \right)
    \cdot
    \left(
  ...
  Массивы \f$a\f$, \f$d\f$, \f$c\f$ содержат коэффициенты системы,
  расположенные соответственно под главной диагональю, на ней и над ней.
